...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //indica a que metodos puede acceder el administrador. Los que no llevan anotacion puede acceder cualqueira
